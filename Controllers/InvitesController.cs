...
namespace BugTracker.Controllers
{
    ...
    public class InvitesController : BTBaseController
    {
        ...
        public InvitesController(ApplicationDbContext context, IProjectService projectService, IDataProtectionProvider dataProtectionProvider, IBTCompanyService companyService, IEmailSender emailSender, UserManager<BTUser> userManager, IBTInviteService inviteService)
        {
            _context = context;
            _projectService = projectService;
            _protector = dataProtectionProvider.CreateProtector("AB.BugTr@cker.2023");
        ...
        public async Task<IActionResult> Index()
        {
            ...
            IEnumerable<Invite> invites = await _inviteService.GetInvitesByCompanyIdAsync(_companyId);
